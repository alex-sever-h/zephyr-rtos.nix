{ stdenv, lib, hostPlatform, fetchurl, autoPatchelfHook, makeBinaryWrapper, xz, python310, which
...
in stdenv.mkDerivation {
  ...
  buildInputs = [ xz python310 ncurses hidapi libftdi1 libusb1 libxcrypt-legacy];
